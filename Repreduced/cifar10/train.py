...
parser.add_argument('-data-dir', metavar='DIR',default="/home/ps/Compact-Transformers-main/cifar-10-python",
...
def main():
    ...
    dataset_train = create_dataset(
        args.dataset, root='~/Dataset/CiFar/10', split=args.train_split, is_training=True,
        batch_size=args.batch_size, repeats=args.epoch_repeats)
    dataset_eval = create_dataset(
        args.dataset, root='~/Dataset/CiFar/10', split=args.val_split, is_training=False, batch_size=args.batch_size)
